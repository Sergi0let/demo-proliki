...
const SearchInput = () => {
  ...
  return (
    <form onSubmit={onSubmit} type="sumbit" className="search-input__search">
      <input
      ...
      />
      <span className="search-input__search-placeholder">{searchIcon}</span>
      <button className="search-input__search-btn">{volumeIcon}</button>
    </form>
  );
};
